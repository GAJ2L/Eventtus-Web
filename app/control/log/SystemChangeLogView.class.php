...
class SystemChangeLogView extends TStandardList
{
    ...
    public function __construct()
    {
        ...
        $date      = new TDataGridColumn('logdate',    'Data',   'center');
        $login     = new TDataGridColumn('login',      'Login',   'center');
        $name      = new TDataGridColumn('tablename',  'Tabela',  'left');
        $column    = new TDataGridColumn('columnname', 'Coluna', 'left');
        $operation = new TDataGridColumn('operation',  'Operação', 'left');
        $oldvalue  = new TDataGridColumn('oldvalue',   'Value Antigo', 'left');
        $newvalue  = new TDataGridColumn('newvalue',   'Novo valor', 'left');
