 ...
 * @author  lucas.tomasi
 */
class SurveyList extends TPage
{
    private $form;
    private $datagrid;
    ...
    public function __construct()
    {
        ...
        $this->form = new TForm('form_search_Survey');
        ...
        $this->form->setFields(array($description));

        $this->form->setData( TSession::getValue('Survey_filter_data') );
        
        $find_button = TButton::create('find', array($this, 'onSearch'), _t('Find'), 'fa:search');
        $new_button  = TButton::create('new',  array('SurveyForm', 'onEdit'), _t('New'), 'fa:plus-square green');
        ...
        $this->datagrid->addColumn( new TDataGridColumn('description', 'Description', 'left', 100) );
        $this->datagrid->addColumn( new TDataGridColumn('activity_id' , 'Activity' , 'center' ,100 ));
        
        $action1 = new TDataGridAction(array('SurveyForm', 'onEdit'));
    ...
    function onReload($param = NULL)
    {
        try
        {
            ...
            if (TSession::getValue('SurveyList_filter_desc')) {
                $criteria->add(TSession::getValue('SurveyList_filter_desc'));
            }
