...
class TCalendar extends TElement
{
    ...
    public function show()
    {
        ...
        $row = $table->addRow();
        $row->addCell('Dom')->class='calendar-header';
        $row->addCell('Seg')->class='calendar-header';
        $row->addCell('Ter')->class='calendar-header';
        $row->addCell('Qua')->class='calendar-header';
        $row->addCell('Qui')->class='calendar-header';
        $row->addCell('Sex')->class='calendar-header';
        $row->addCell('Sáb')->class='calendar-header';
